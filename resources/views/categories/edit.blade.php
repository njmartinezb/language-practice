                    ...
                    <form action="{{ route('categories.update', $category) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="{{ __('Actualiza el nombre') }}"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description"
                                      id="description"
                                      placeholder="{{ __('Actualiza la descripción (opcional)') }}"
                                      class="dark:text-white mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('description', $category->description) }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
